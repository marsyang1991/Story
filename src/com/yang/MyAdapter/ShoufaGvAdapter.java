...
public class ShoufaGvAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// 设置文字和图片
		// bitmapUtils.display(listItemView.image,
		// imageUrl+datas.get(position).getPicSmallUrl());
		bitmapUtils.display(listItemView.image, imageUrl
				+ datas.get(position).getPicBigUrl());
