		...
		tv_search.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if(!ss.trim().equals("")){
					...
					http.send(HttpMethod.GET, urlBase+"search_file_api.do?keyword="+ss.trim(), null, new RequestCallBack<String>(){
						...
						public void onSuccess(ResponseInfo<String> responseInfo) {
							...
							try {
								...
								while(reader.hasNext())
								{
									...
									reader.endObject();
									storyList.add(story);
									//Toast.makeText(SearchActivity.this, storyList.size()+"", Toast.LENGTH_SHORT).show();
								}
								reader.endArray();
								reader.close();
							} catch (Exception e) {
							...
							if(storyList.size()!=0)
							{
								SearchGvAdapter adapter = new SearchGvAdapter(SearchActivity.this, storyList);
								...
								Toast.makeText(SearchActivity.this, "无相关记录", Toast.LENGTH_SHORT).show();
							}
