...
public class ZuixinshoufaActivity extends Activity{
	...
	private void init()
	{
		...
		zuixin_list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				Intent intent = new Intent(ZuixinshoufaActivity.this, XiangqingActivity.class);
	...
	private void updateData()
	{
		...
		http.send(HttpMethod.GET, urlBase+"list_top_file_api.do?limitNumber=20", null, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				SearchGvAdapter shoufaAdapter = new SearchGvAdapter(ZuixinshoufaActivity.this,storyList);
				zuixin_list.setAdapter(shoufaAdapter);
				
			}
			@Override
			public void onFailure(HttpException error, String msg) {
				Toast.makeText(ZuixinshoufaActivity.this, "服务器错误", Toast.LENGTH_SHORT).show();
			}
			@Override
