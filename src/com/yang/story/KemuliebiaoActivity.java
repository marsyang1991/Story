...
public class KemuliebiaoActivity extends Activity{
	...
	private void updateKemuList(String kemuString2) {
		...
		http.send(HttpMethod.GET,  urlBase+"list_subject_file_api.do?subjectID="+sujectID, null, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				SearchGvAdapter adapter = new SearchGvAdapter(KemuliebiaoActivity.this,storyList);
				kemu_list.setAdapter(adapter);
				kemu_list.setOnItemClickListener(new OnItemClickListener() {

					@Override
					public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
							long arg3) {
						Intent intent = new Intent(KemuliebiaoActivity.this, XiangqingActivity.class);
			...
			public void onFailure(HttpException error, String msg) {
				Toast.makeText(KemuliebiaoActivity.this, "服务器错误", Toast.LENGTH_SHORT).show();
			}
			@Override
