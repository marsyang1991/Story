...
public class SettingBook1Activity extends Activity{
	...
	WheelView cityWheelView, gradeWheelView,subjectWheelView,versionWheelView;
	Button btNext;
	Dialog pd;
	String urlBase;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		btNext.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				String cityId = cityList.get(cityWheelView.getCurrentItem()).get("id");
				String gradeId = gradeList.get(gradeWheelView.getCurrentItem()).get("id");
				String subjectId = subjectList.get(subjectWheelView.getCurrentItem()).get("id");
				String versionId = versionList.get(versionWheelView.getCurrentItem()).get("id");
				Intent intent = new Intent(SettingBook1Activity.this,SettingBook2Activity.class);
	...
	private void getKemu()
	{
		...
		httpSubject.send(HttpMethod.GET, urlBase+"list_subject_api.do", null, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				try {
					...
					subjectWheelView.setViewAdapter(new ListMapWheelAdapter(SettingBook1Activity.this, subjectList));
			...
			public void onFailure(HttpException error, String msg) {
				Toast.makeText(SettingBook1Activity.this, "获取科目失败", Toast.LENGTH_SHORT).show();
				finish();
			}
	...
	private void getVersion()
	{
		...
		httpVersion.send(HttpMethod.GET, urlBase+"list_version_api.do", null, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				try {
					...
					versionWheelView.setViewAdapter(new ListMapWheelAdapter(SettingBook1Activity.this, versionList));
			...
			@Override
			public void onFailure(HttpException error, String msg) {
				Toast.makeText(SettingBook1Activity.this, "获取版本失败", Toast.LENGTH_SHORT).show();
				finish();
			}
			@Override
			public void onLoading(long total, long current,
	...
	private void getGrade()
	{
		//获取年级信息
				...
				httpGrade.send(HttpMethod.GET, urlBase+"list_grade_api.do", null, new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						try {
							...
							gradeWheelView.setViewAdapter(new ListMapWheelAdapter(SettingBook1Activity.this, gradeList));
					...
					@Override
					public void onFailure(HttpException error, String msg) {
						Toast.makeText(SettingBook1Activity.this, "获取年级失败", Toast.LENGTH_SHORT).show();
						finish();
					}
					@Override
					public void onLoading(long total, long current,
	...
	private void getCity()
	{
		...
		http.send(HttpMethod.GET, urlBase+"list_city_api.do?provinceId="+provinceId, null, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				try {
					...
					cityWheelView.setViewAdapter(new ListMapWheelAdapter(SettingBook1Activity.this, cityList));
			...
			@Override
			public void onFailure(HttpException error, String msg) {
				Toast.makeText(SettingBook1Activity.this, "获取城市失败", Toast.LENGTH_SHORT).show();
				finish();
			}
			@Override
			public void onLoading(long total, long current,
