...
public class SetProvinceActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		provinceList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent intent = new Intent(SetProvinceActivity.this,SettingBook1Activity.class);
	...
	private void initWidgeContent()
	{
		...
		http.send(HttpMethod.GET, urlBase+"list_province_api.do?countryId=2", null, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				try {
					...
					String[] from = {"name"};
					int[] to = {R.id.txt};
					SimpleAdapter simpleAdapter = new SimpleAdapter(SetProvinceActivity.this, cityList, R.layout.item_provincelist, from, to);
