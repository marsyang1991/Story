...
public class ZuireActivity extends Activity{
	LinearLayout zuire_back;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_zuire);
		init();
	}
	private void init()
	{
		...
		zuixin_list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				Intent intent = new Intent(ZuireActivity.this, XiangqingActivity.class);
		...
		updateData();
		zuire_back = (LinearLayout)findViewById(R.id.zuire_back);
		zuire_back.setOnClickListener(new OnClickListener() {
	...
	private void updateData()
	{
		...
		http.send(HttpMethod.GET, urlBase+"list_hot_file_api.do?limitNumber=20", null, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				SearchGvAdapter shoufaAdapter = new SearchGvAdapter(ZuireActivity.this,storyList);
				zuixin_list.setAdapter(shoufaAdapter);
				
			}
			@Override
			public void onFailure(HttpException error, String msg) {
				Toast.makeText(ZuireActivity.this, "服务器错误", Toast.LENGTH_SHORT).show();
			}
			@Override
