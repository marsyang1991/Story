...
public class ZuireActivity extends Activity {
	...
	private void init() {
		...
		zuixin_list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				Intent intent = new Intent(ZuireActivity.this,
	...
	private void updateData() {
		...
		http.send(HttpMethod.GET, urlBase
				+ "list_hot_file_api.do?limitNumber=20", null,
				new RequestCallBack<String>() {
					...
					public void onFailure(HttpException error, String msg) {
						Toast.makeText(ZuireActivity.this, "服务器错误",
								Toast.LENGTH_SHORT).show();
					}
