	...
	private void updateUser() {
		...
		http.send(HttpMethod.GET, urlBase+"api_get_user.do?"+"uid="+FrameActivity.user.getUid(), null, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				//FrameActivity.user.setNickname(jsonObject.getString("nickName"));
				//FrameActivity.user.setGender(jsonObject.getString("gender"));
				Textbook book = new Textbook();
				book.setAreaID(jsonObject.getInt("areaID"));
				book.setGradeId(jsonObject.getInt("gradeID"));
				FrameActivity.user.setBook(book);
				Util.saveUser(LoginActivity.this, FrameActivity.user);
			}
